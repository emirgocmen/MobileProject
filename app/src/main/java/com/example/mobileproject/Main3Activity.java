...
public class Main3Activity extends AppCompatActivity {
    ...
    public void sorucek()
    {
        plycorrect=MediaPlayer.create(Main3Activity.this,R.raw.correct);
        plywrong=MediaPlayer.create(Main3Activity.this,R.raw.wrong);
        plycong=MediaPlayer.create(Main3Activity.this,R.raw.cong);
        ...
        collectionReference.whereEqualTo("qnumber",rastgelesoru).addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                if(e != null)
                {
                    Toast.makeText(Main3Activity.this,e.getLocalizedMessage().toString(),Toast.LENGTH_SHORT).show();
                }
                ...
                if(queryDocumentSnapshots != null)
                {
                    for(DocumentSnapshot snapshot:queryDocumentSnapshots.getDocuments())
                    {
                        ...
                        String choise1=(String) data.get("choice1");
                        ...
                        if(ssayi == 0)
                        {
                            countDownTimer=new CountDownTimer(60000,1000){
                                ...
                                {
                                    Toast.makeText(Main3Activity.this,R.string.hata2,Toast.LENGTH_SHORT).show();
                                    ...
                                    new CountDownTimer(1000,1000){
                                        ...
                                        public void onFinish()
                                        {
                                            ...
                                            if(ssayi== 10)
                                            {
                                                ...
                                                plycong.start();
                                                Toast.makeText(Main3Activity.this,R.string.tebrikler,Toast.LENGTH_LONG).show();
                                                ...
                                                firestore.collection("Scores").add(gonderilen).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(Main3Activity.this,R.string.hata3,Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                ...
                                else
                                {
                                    ...
                                    new CountDownTimer(1000,1000){
                                        ...
                                        public void onFinish()
                                        {
                                            ...
                                            Toast.makeText(Main3Activity.this,R.string.hata1,Toast.LENGTH_SHORT).show();
                                            Intent i=new Intent(Main3Activity.this,Main2Activity.class);
                                            startActivity(i);
    ...
    {
        rastgelesoru=rastgele.nextInt(11);

        for(i=0;i<10;i++){
            if(cekilensorular[i] == rastgelesoru || rastgelesoru == 0)
            {
                sorukontrol();
            }
        }
